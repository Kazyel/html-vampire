...
const renderPowerUpScreen = (canvasCtx: CanvasRenderingContext2D): void => {
  const titleSize = 48;
  ...
  canvasCtx.fillText('YOU LEVELED UP!', CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2);
...
export default renderPowerUpScreen;
